...
For each region $r$, technology $i$, and IPC category $c$, we construct two embedding vectors capturing $i$'s directional network position and compare them to $r$'s average embededness for technologies in category $c$.
...
**Coherence** is the cosine similarity between technology $i$'s directional embededness and region $r$'s average directional embededness for category $c$:
