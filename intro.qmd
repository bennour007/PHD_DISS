...
With this in mind, we propose a multilayered contextual framework in which we distinguish between the endogenous (technology-region fit) and exogenous (national, spatial factors) conditions. With that, we can identify which combinations enable feasible diversification across different regional contexts opertionalised through this structured desgin:  
