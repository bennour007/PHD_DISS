...
explicitly include the ndogenous characteristics of the technologies and
regions contingent on the regional knowledge infrastructure while
...
\begin{itemize}
\item
  H2a: Technology-specific characteristics has different impact on
  diversification contingent on the regional knowledge coherence.
\item
  H2b: Technology-specific characteristics has different impact on
  diversification contingent on the regional knowledge stock.
\end{itemize}
