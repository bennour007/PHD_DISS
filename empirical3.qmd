...
- **H3b (Bridging moderation):** Technologies with a bridging role are more beneficial for regions with low coherence than for regions with high coherence, meaning that bridge technologies matter most as diversification pathways when direct alignment is limited [@zhu2021strong].
...
hypotheses <- tibble(
  ...
  Claim = c(
    ...
    "Bridging technologies are more beneficial for low-coherence regions",
    "The enabling technology penalty is smaller for high-coherence regions",
    ...
    "Enabling portfolio concentration is positively associated with potential"
  ),
  Key_variables = c(
...
```{r tbl-desc-panel}
#| tbl-cap: "Descriptive statistics of the aggregated varaibles"
...
#| tbl-cap: "Correlation matrix of the aggregated varaibles"
